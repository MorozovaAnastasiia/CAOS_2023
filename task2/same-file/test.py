...
if __name__ == "__main__":
    touch_test_files()
    expect_answer("file", "file", "yes")
    expect_answer("file", pathlib.Path("file").resolve(), "yes")
    expect_answer(pathlib.Path("file").resolve(), pathlib.Path("file").resolve(), "yes")
    expect_answer("dir/./../dir/../file", "file", "yes")
    expect_answer("file", "hardlink-file", "yes")
    expect_answer("file", "symlink-file", "yes")
    expect_answer("file", "symlink-symlink-file", "yes")
    expect_answer("file", "symlink-hardlink-file", "yes")
    expect_answer("symlink-file", "symlink-file", "yes")
    expect_answer("symlink-file", "symlink-symlink-file", "yes")
    expect_answer("symlink-file", "symlink-hardlink-file", "yes")
    expect_answer(".", ".", "yes")
    expect_answer("dir", "symlink-dir", "yes")
    expect_answer("dir", "symlink-symlink-dir", "yes")
    expect_answer("symlink-dir", "symlink-symlink-dir", "yes")
    expect_answer("file", "file2", "no")
    expect_answer("dir", "dir2", "no")
    expect_answer(".", "..", "no")
    expect_answer("file", "dir", "no")
    expect_answer("file", "/path/to/nowhere", "no")
    expect_answer("file", "dangling-symlink", "no")
    expect_answer("dir", "/path/to/nowhere", "no")
    expect_answer("dir", "dangling-symlink", "no")
    expect_answer("/path/to/nowhere", "/path/to/nowhere", "no")
    expect_answer("dangling-symlink", "/path/to/nowhere", "no")
    expect_answer("dangling-symlink", "dangling-symlink", "no")
    expect_answer("file", "begin-cycle", "no")
    expect_answer("dangling-symlink", "begin-cycle", "no")
    expect_answer("begin-cycle", "begin-cycle", "no")
    expect_answer("begin-cycle", "end-cycle", "no")
    expect_failure("x", "y", "z")
    expect_failure("x")
    expect_failure()
